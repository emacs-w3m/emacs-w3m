...
(luna-define-class shimbun-moz-users (shimbun-fml) ())

(defvar shimbun-moz-users-url "http://www.mozilla.gr.jp/ml/logs/moz-users/")
(defvar shimbun-moz-users-groups '("users"))

(provide 'sb-moz-users)

;;; sb-moz-users.el ends here
