...
(defvar shimbun-ffii-group-alist
  '(("news.software-patent.en" . "SwpatcninoEn")
    ("news.software-patent.ffii.en" . "SwpatcninoEn-ffii")
    ("news.software-patent.de" . "SwpatcninoDe")
    ("news.software-patent.ffii.de" . "SwpatcninoDe-ffii")
    ("news.software-patent.fr" . "SwpatcninoFr")
    ("news.software-patent.ffii.fr" . "SwpatcninoFr-ffii")
    ("news.software-patent.nl" . "SwpatcninoNl")
    ("news.software-patent.ffii.nl" . "SwpatcninoNl-ffii")
    ("news.information-infrastructure.en" . "FfiinewsEn")
    ("news.information-infrastructure.de" . "FfiinewsDe")
    ("news.project.en" . "FfiiprojNewsEn")))
